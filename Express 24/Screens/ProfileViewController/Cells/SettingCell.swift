...
final class SettingCell: UITableViewCell {
    ...
    override init(style:UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        cellView.addSubview(languageImageView)
        languageImageView.translatesAutoresizingMaskIntoConstraints = false
        languageImageView.setConstraint(from: .left, from: self, 16)
        languageImageView.setConstraint(from: .yCenter, from: self)
        ...
        nameLabel.leadingAnchor.constraint(equalTo: languageImageView.trailingAnchor, constant: 16).isActive = true
